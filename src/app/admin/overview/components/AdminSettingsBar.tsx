...
import { BookOpen, LayoutDashboard, Users, PlusCircle, Lock, Edit3 } from "lucide-react";
...
const OPTIONS = [
    ...
    },
    {
        ...
        label:   "Overview",
        href:    "/admin/overview",
        bg:      "bg-blue-100 text-blue-600 border-blue-100/50",
                ...
                return (
                    <Link key={opt.label} href={opt.href}>
                        <motion.div
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="group flex cursor-pointer flex-col items-center justify-center gap-4 rounded-2xl border border-[#e5e7eb] bg-white p-5 shadow-sm transition-all duration-200 hover:border-[#d1d5db] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)]"
                        >
